//
//  EmailValidationPresenter.swift
...
protocol EmailValidationPresentationLogic: PresentationLogic {
    func presentValidateEmail(isValid: Bool)
}

extension EmailValidationPresentationLogic {
    func presentValidateEmail(isValid: Bool) {
